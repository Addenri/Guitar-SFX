...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Distortion Demo Installer\n"
      else:
        line="OutputBaseFilename=Distortion Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Distortion Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Distortion installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Distortion Demo installer\n"
     else:
       line="SetupWindowTitle=Distortion installer\n"
