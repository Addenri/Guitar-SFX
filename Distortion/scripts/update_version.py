...
def main():
  ...
  plistpath = scriptpath + "/resources/Distortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Distortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Distortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Distortion-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Distortion-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Distortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Distortion.iss",inplace=1):
