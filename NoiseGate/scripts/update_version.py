...
def main():
  ...
  plistpath = scriptpath + "/resources/NoiseGate-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NoiseGate-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NoiseGate-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NoiseGate-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NoiseGate-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/NoiseGate.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/NoiseGate.iss",inplace=1):
