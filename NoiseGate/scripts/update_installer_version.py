...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NoiseGate Demo Installer\n"
      else:
        line="OutputBaseFilename=NoiseGate Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NoiseGate Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NoiseGate installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NoiseGate Demo installer\n"
     else:
       line="SetupWindowTitle=NoiseGate installer\n"
