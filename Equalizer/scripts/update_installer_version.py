...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Equalizer Demo Installer\n"
      else:
        line="OutputBaseFilename=Equalizer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Equalizer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Equalizer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Equalizer Demo installer\n"
     else:
       line="SetupWindowTitle=Equalizer installer\n"
