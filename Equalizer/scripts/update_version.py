...
def main():
  ...
  plistpath = scriptpath + "/resources/Equalizer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Equalizer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Equalizer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Equalizer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Equalizer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Equalizer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Equalizer.iss",inplace=1):
