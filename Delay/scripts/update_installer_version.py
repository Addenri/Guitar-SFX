...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Delay Demo Installer\n"
      else:
        line="OutputBaseFilename=Delay Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Delay Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Delay installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Delay Demo installer\n"
     else:
       line="SetupWindowTitle=Delay installer\n"
